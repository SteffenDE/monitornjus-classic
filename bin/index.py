...
<body>"""
	...
	if read_values.read_uhraktiv == 1:
		if read_values.read_uhrvmargin == "center":
			uhr = """
	<div id="uhr" style="height:"""+str(read_values.read_uhrheight)+""";width:"""+str(read_values.read_uhrwidth)+""";"""+read_values.read_uhrvalign+""":"""+str(read_values.read_uhralign)+""";">
	...
	if read_values.read_adminlinkaktiv == 1:
		print """
	<div id="admin_link" style="background:none; """+read_values.read_adminlinkvalign+""":"""+str(read_values.read_adminlinkalign)+""";">
	...
	if read_values.read_widgetaktiv == 1:
		print """
	<div id="widget" style=height:"""+str(read_values.read_widgetheight)+""";width:"""+str(read_values.read_widgetwidth)+""";"""+read_values.read_widgetvalign+""":"""+str(read_values.read_widgetalign)+""";"""+read_values.read_widgetvmargin+""":"""+str(read_values.read_widgetmargin)+"""></div>"""
